...
class ClaudeChat(QWidget):
    ...
    def set_linux_env_variable(self, name, value):
        """
        Sets linux env variable based on name, value.
        """
        try:
            # Update for the current process
            os.environ[name] = value

            # Add or update the environment variable in ~/.profile
            ...
            logging.info(f"Environment variable '{name}' set to '{value}' in ~/.profile and current process")
    ...
    def set_macos_env_variable(self, name, value):
        """
        Sets macos env variable based on name, value.
        """
        try:
            # Update for the current process
            os.environ[name] = value
